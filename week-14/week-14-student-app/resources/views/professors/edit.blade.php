...
<div class="container mt-4">
    <h2 class="mb-4">Edit Professor</h2>
    ...
    <form action="{{ route('professors.update', $professor->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="fname" class="form-control @error('fname') is-invalid @enderror"
                   id="fname" value="{{ old('fname', $professor->fname) }}" required>
            @error('fname')
        ...
        <div class="mb-3">
            ...
            <input type="text" name="lname" class="form-control @error('lname') is-invalid @enderror"
                   id="lname" value="{{ old('lname', $professor->lname) }}" required>
            @error('lname')
                <span class="invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                   id="email" value="{{ old('email', $professor->email) }}" required>
            @error('email')
                <span class="invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
